...
//    if (aParticle->GetCharge() == 0) return false;
	...
	newHit->myData.Pz = aTrack->GetMomentum().z();
         ...
         if (PreName == "volume" && PostName == "West") newHit->myData.StationID = 1;
    else if (PreName == "volume" && PostName == "North") newHit->myData.StationID = 2;
    else if (PreName == "volume" && PostName == "South") newHit->myData.StationID = 3;
